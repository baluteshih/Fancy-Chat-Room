...
SRCS = src/helper.cpp src/http.cpp src/socket.cpp src/main_thread.cpp src/file.cpp src/db.cpp src/server_object.cpp src/crypto.cpp src/html.cpp
...
clean:
	rm -rf $(OBJS) $(DEPS) test http_test db_test server client
